...
namespace Cooper.Web
{
    ...
    public class AutofacModuleRegister : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterAssemblyTypes(GetAssemblyByName("Cooper.Service")).Where(a => a.Name.EndsWith("Service")).AsImplementedInterfaces();
            //注册Repository中的对象,Repository中的类要以Repository结尾，否则注册失败
            builder.RegisterAssemblyTypes(GetAssemblyByName("Cooper.Repository")).Where(a => a.Name.EndsWith("Repository")).AsImplementedInterfaces();
            //单独注册
